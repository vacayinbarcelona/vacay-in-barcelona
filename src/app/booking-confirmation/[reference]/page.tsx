          ...
          <div key={booking.id}>
            <section className="mt-8 border border-gray-200 rounded-2xl overflow-hidden">
              <div className="grid grid-cols-1 sm:grid-cols-[200px_1fr]">
                <div className="flex flex-col items-center justify-center gap-2 p-6 bg-gray-50 border-b sm:border-b-0 sm:border-r border-gray-200">
                  ...
                  <p className="text-[11px] text-gray-500 text-center">Show this at entry — no printing needed</p>
                </div>
                  ...
                  <div className="flex flex-wrap items-start gap-4 pb-4 border-b border-gray-100">
                    {thumbnail ? (
                      <div className="relative w-14 h-14 rounded-xl overflow-hidden flex-shrink-0">
                        <Image src={thumbnail} alt={thumbnailAlt} fill className="object-cover" sizes="56px" />
                      </div>
                    ) : null}
