...
export default function SignUpPage({ searchParams }: { searchParams: { error?: string; redirect?: string } }) {
  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center bg-gray-50 px-6 py-14">
      <div className="w-full max-w-sm">
        ...
        <h1 className="text-center text-xl font-semibold mb-1">Create your account</h1>
        <p className="text-sm text-gray-500 mb-8 text-center">Track your bookings and check out faster next time.</p>
        ...
        <p className="text-sm text-gray-500 text-center mt-5">
          ...
          <Link href={`/account/sign-in?redirect=${encodeURIComponent(redirectTo)}`} className="text-blue-600 font-medium hover:text-blue-700">
            Sign in
          </Link>
        </p>
      </div>
